...
?>
    ...
    <div class=1contact_top">
        <div class="container">
            <div class="col-md-6 contact_left wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInRight;">
                <h4><?=$title?></h4>
            ...
            <div class="col-md-6 company-right wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft;">
